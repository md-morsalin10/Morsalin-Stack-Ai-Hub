...
const BannerSection = () => {
    return (
        <div className='max-w-7xl mx-auto pb-8 relative overflow-hidden'>
            <div className='bg-linear-to-b from-[#EAEEFE] to-[#183EC2] pl-11 flex'>
                <div className='flex justify-center py-30'>
                    <div className="content flex flex-col  space-y-8">
                        ...
                        <div>
                            <h2 className='text-5xl md:text-7xl font-bold tracking-tighter bg-linear-to-b from-[#000000] to-[#011354] bg-clip-text text-transparent py-4 space-y-2'>The Ultimate Stack <br /> for Creative Minds.</h2>
                        </div>
                        <div>
                            <p className='text-[#010D3E] text-xl'>From advanced vector design to high-fidelity AI generation <br /> find everything you need to build  the future, all in one seamless platform.</p>
                        </div>
                    ...
                    <div className='absolute left-140 top-4 animate-smooth-float'>
                        <img src={cylinder} alt="" />
                    </div>

                </div>
                <div className="image animate-smooth-float [animation-duration:6s]">
                    <img src={bannerImg} alt="" />
                </div>
            </div>
            <div className='absolute top-110 right-0 animate-smooth-float [animation-duration:4s] [animation-delay:1s]'>
                <img src={half} alt="" />
            </div>
        </div>
    );
